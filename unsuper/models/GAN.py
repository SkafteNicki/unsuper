...
#%%
class GAN(object):
    def __init__(self, input_shape, latent_dim, Generator, Discriminator, device='cpu'):
        # Device to run on
        # Initialize
    ...
    def train(self, trainloader, n_epochs, learning_rate=1e-3):
        ...
        for epoch in range(n_epochs):
            for i, (imgs, _) in enumerate(trainloader):
                ...
                print ("[Epoch %d/%d] [Batch %d/%d] [D loss: %f] [G loss: %f]" % (epoch, n_epochs, i, len(trainloader),
